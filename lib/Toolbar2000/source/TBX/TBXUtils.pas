...
procedure EllipseEx(DC: HDC; Left, Top, Right, Bottom: Integer; OutlineColor, FillColor: TColor); overload; {vb+}
procedure EllipseEx(DC: HDC; const R: TRect; OutlineColor, FillColor: TColor); overload; {vb+}
...
procedure RectangleEx(DC: HDC; Left, Top, Right, Bottom: Integer; OutlineColor, FillColor: TColor); overload; {vb+}
procedure RectangleEx(DC: HDC; const R: TRect; OutlineColor, FillColor: TColor); overload; {vb+}
procedure RoundRectEx(DC: HDC; Left, Top, Right, Bottom, EllipseWidth, EllipseHeight: Integer; OutlineColor, FillColor: TColor); overload; {vb+}
procedure RoundRectEx(DC: HDC; const R: TRect; EllipseWidth, EllipseHeight: Integer; OutlineColor, FillColor: TColor); overload; {vb+}
...
asm
        ...
        SHR     EAX,16
        XCHG    AL,CL
{        MOV     AH,$00          // and writes $FF into A component } {vb-}
        MOV     AH,$FF          // and writes $FF into A component } {vb+}
        SHL     EAX,16
        MOV     AX,CX
end;
...
procedure EllipseEx(DC: HDC; const R: TRect; OutlineColor, FillColor: TColor); {vb+}
begin
  with R do
...
procedure RectangleEx(DC: HDC; const R: TRect; OutlineColor, FillColor: TColor); {vb+}
begin
  with R do
...
procedure RoundRectEx(DC: HDC; Left, Top, Right, Bottom, EllipseWidth,
  EllipseHeight: Integer; OutlineColor, FillColor: TColor); {vb+}
var
  OldPen: HPEN;
  OldBrush: HBRUSH;
begin
...
begin
  ...
  begin
    ...
    { vb+ Note: Windows9x has a bug in GradientFill function:
      not fill window nonclient area. So we use GradientFill
      only in WindowsNT }
...
initialization
  ...
  @AlphaBlend := GetProcAddress(hMSImg, 'AlphaBlend');
  @GradientFill := GetProcAddress(hMSImg, 'GradientFill');} {vb-}
  InitializeProcs; {vb+}
  InitializeStock;
